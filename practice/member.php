...
<section>
<br>
<div id=section1>학생 정보 입력</div><br>
<div align=center>
...
<table border=1>
    ...
    <tr>
        <td class="td1">사진</td>
        <td class="td1"><input type=file name=img></td>
    </tr>
    <tr>
        <td colspan=2 class="td1"><input type=submit value="저 장 하 기"></td>
    </tr>
</table>
</form>
</div>
