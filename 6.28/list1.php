...
<section> 
<br><br>    
<div align=center> <font size=4> <b> 학생 목록 보기(1) </b></font>  </div>    
<div  align=center>
   <br> 
   <?
   ...
   <a href=list1.php?idx=0&ch1=<?=$ch1?>&ch2=<?=$ch2?>>처음</a> &emsp;
  ...
  <? 
   ...
   ?>
    <a href=list1.php?idx=<?=$end_page?>&ch1=<?=$ch1?>&ch2=<?=$ch2?>> 마지막 </a>
